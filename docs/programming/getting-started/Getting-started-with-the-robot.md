...
You should have already followed the **Installing programs** articles at this point. If not, [go back to Home](/index/) and do those first.
...
If you've finished this article, great work! The next step is to learn more about [subsystems](/programming/getting-started/Subsystems/).